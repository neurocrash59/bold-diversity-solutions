...
<div
	class="loginModal hidden w-full h-full overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none flex flex-col justify-center items-center"
>
