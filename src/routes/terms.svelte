<section class="py-12">
	<article class="container md:w-2/3 bg-light-500 p-6 border rounded-lg shadow">
		<h3 class="text-3xl font-semibold">Terms of Use</h3>

		<hr class="my-8" />

		<p>
			The following Terms of Use are entered into by and between You and Aqua Wealth & Media LLC (“
		...
		<p>
			...
			Privacy Policy, incorporated herein by reference. If you do not want to agree to these Terms
			of Use including the agreements incorporated by reference herein, you must not access or use
			the Website.
		</p>
		...
		<p>
			Your use of the Website is also subject to the Company’s Privacy Policy. Please review our
			Privacy Policy, which also governs the Website and informs users of our data collection
			practices. Your agreement to the Privacy Policy is hereby incorporated into these Terms of
			Use.
		</p>
		...
		<p>
			...
			Disclaimer, which also governs the Website and informs users of various limitations regarding
			the information provided on the Website. Your agreement to the Disclaimer is hereby
		...
		<p>
			...
			time, we may restrict access to some parts of the Website, or the entire Website, to users,
			including registered users.
		</p>

		<p>
			To access the Website or some of the resources it offers, you may be asked to provide certain
			registration details or other information. It is a condition of your use of the Website and
			any resources downloaded from the Website that all the information you provide on the Website
			is correct, current, and complete. You agree that all information you provide to register with
			this Website or otherwise, including but not limited to through the use of any interactive
			features on the Website, is governed by our Privacy Policy, and you consent to all actions we
		...
		<p>
			...
			any other breach of security. You also agree to ensure that you exit from your account at the
			end of each session. You should use particular caution when accessing your account from a
		...
		<p>
			...
			the Website or any of the resources available for download from the Website for any purpose
			that is unlawful or prohibited by these Terms. You may not use the Website or any of the
			resources available for download from the Website in any manner that could damage, disable,
			...
			means not intentionally made available or provided for through the Website.
		</p>

		<p>
			All content included as part of the Service, such as text, graphics, logos, images, as well as
			the compilation thereof, and any software used on the Website, is the property of the Company
			or its suppliers and protected by copyright and other laws that protect intellectual property
		...
		<p>
			...
			on the Website or any of the resources available for download from the Website.
		</p>

		<p>
			The Company content is not for resale. Your use of the Website or any of the resources
			available for download from the Website does not entitle you to make any unauthorized use of
			any protected content, and in particular you will not delete or alter any proprietary rights
			or attribution notices in any content. You will use protected content solely for your
		...
		<p>
			The Company name, the Company logo, the Company slogan, and all related names, logos, product
		...
		<p>
			...
			information provided on this Website and the resources available for download are accurate and
			provide valuable information, but we cannot guarantee the accuracy of the information. Neither
			the Company nor any of its owners or employees shall be held liable or responsible for any
			errors or omissions on this Website or for any damage you may suffer as a result of failing to
			seek competent advice from a professional who is familiar with your situation.
		</p>
		...
		<p>
			...
			guarantees about the results of taking any action, whether recommended on this Website or not.
			The Company provides educational and informational resources that are intended to help users
			of this Website succeed. You nevertheless recognize that your ultimate success or failure will
		...
		<p>
			...
			out in this Website are no guarantee that you or any other person or entity will be able to
		...
		<p>
			...
			or any contractual relationship. As set forth more fully in our Privacy Policy, we will take
		...
		<p>
			...
			you will not: defame, abuse, harass, stalk, threaten or otherwise violate the legal rights
			(such as rights of privacy and publicity) of others; publish, post, upload, distribute or
			disseminate any inappropriate, profane, defamatory, infringing, obscene, indecent or unlawful
			topic, name, material or information; upload files that contain software or other material
			protected by intellectual property laws (or by rights of privacy of publicity) unless you own
			or control the rights thereto or have received all necessary consents; upload files that
			contain viruses, corrupted files, or any other similar software or programs that may damage
			the operation of another's computer; advertise or offer to sell or buy any goods or services
			for any business purpose, unless such Communication Service specifically allows such messages;
			conduct or forward surveys, contests, pyramid schemes or chain letters; download any file
			posted by another user of a Communication Service that you know, or reasonably should know,
			cannot be legally distributed in such manner; falsify or delete any author attributions, legal
			or other proper notices or proprietary designations or labels of the origin or source of
			software or other material contained in a file that is uploaded, restrict or inhibit any other
			user from using and enjoying the Communication Services; violate any code of conduct or other
		...
		<p>
			...
			materials in its sole discretion. The Company reserves the right to terminate your access to
		...
		<p>
			...
			disclaims any liability with regard to the Communication Services and any actions resulting
			from your participation in any Communication Service. Managers and hosts are not authorized
			the Company spokespersons, and their views do not necessarily reflect those of the Company.
		</p>
		...
		<p>
			...
			services (collectively “Submissions”). However, by posting, uploading, inputting, providing,
			or submitting your Submission you are granting the Company, our affiliated companies, and
			necessary sub-licensees permission to use your Submission in connection with the operation of
			their Internet businesses including, without limitation, the rights to: copy, distribute,
		...
		<p>
			...
			in this section including, without limitation, all the rights necessary for you to provide,
		...
		<p>
			...
			not under the control of the Company and the Company is not responsible for the contents of
			any Linked Website, including without limitation any link contained in a Linked Website, or
			any changes or updates to a Linked Website. The Company is providing these links to you only
			as a convenience, and the inclusion of any link does not imply endorsement by the Company of
			the Website or any association with its operators.
		</p>

		<p>
			Certain services made available via the Website are delivered by third-party Websites and
			organizations. By using any product, service, or functionality originating from the Website,
			you hereby acknowledge and consent that the Company may share such information and data with
		...
		<p>
			The Company provides various templates and/or forms for download and/or sale on this Website.
			The Company grants you a limited, personal, non-exclusive, non-transferable license to use our
			templates and/or forms for your own personal or internal business use. Except as otherwise
			provided, you acknowledge and agree that you have no right to modify, edit, copy, reproduce,
			create derivative works of, reverse engineer, alter, enhance or in any way exploit any of the
			templates and/or forms in any manner, except for modifications in filling out the templates
			and/or forms for your authorized use.
		</p>

		<p>
			By ordering or downloading Forms, you agree that the Forms you purchase or download may only
			be used by you for your personal or business use and may not be sold or redistributed without
		...
		<p>
			The Company from time-to-time provides various courses, programs, and associated material for
			sale on this Website. The Company grants you a limited, personal, non-exclusive,
			non-transferable license to use our courses, programs, and associated material (collectively
			the “Courses”) for your own personal or internal business use. Except as otherwise provided,
			you acknowledge and agree that you have no right to modify, edit, copy, reproduce, create
			derivative works of, reverse engineer, alter, enhance or in any way exploit any of the Courses
			in any manner.
		</p>
		...
		<p>
			...
			derivative work based upon the Courses and you shall not offer any competing products or
		...
		<p>
			The Company provides various resources on this Website, which users may access by providing an
			e-mail address. The Company grants you a limited, personal, non-exclusive, non-transferable
			...
			acknowledge and agree that you have no right to modify, edit, copy, reproduce, create
			derivative works of, reverse engineer, alter, enhance or in any way exploit any of the
			Freemium Content in any manner.
		</p>
		...
		<p>
			...
			derivative work based upon the Freemium Content and you shall not offer any competing products
			or services based upon any information contained in the Freemium Content.
		</p>
		...
		<p>
			...
			Company does not control the information provided by such third-party guests, is not
			responsible for investigating the truth of any information provided, and cannot guarantee the
		...
		<p>
			...
			transfer all intellectual property rights they may have in any such interviews to the Company
			and further provide a license to any rights they are unable to assign.
		</p>

		<p><strong>Cancellation Of Subscription</strong></p>

		<p>
			Certain of the Company’s products and services are offered on an ongoing basis with a monthly
			or yearly subscription. Users may cancel subscriptions at any time by emailing
		...
		<p>
			...
			guarantee is governed by the following terms, except to the extent that the terms of a
			specific product or service provide otherwise.
		</p>

		<p>
			With respect to any purchase, you must request your money back within 30 days of the purchase.
			You may request your money back by emailing
			<a href="mailto:hello@bolddiversitysolutions.com">hello@bolddiversitysolutions.com</a>
			. That email must contain information about the product you purchased, the date of the purchase,
			and the email and name associated with any such purchase. You are not required to submit any proof
			that you have completed any work or meet any other requirements.
		</p>
		...
		<p>
			...
			under these Terms of Use or any other agreement. You shall immediately cease using the
			material and shall destroy all copies of the information provided to you, including without
			limitation: video recordings, audio recordings, forms, template documents, slide shows,
		...
		<p>
			...
			many products and/or services the customer purchases. In other words, after a customer has
			received a refund for any one product under this money-back guarantee, that customer shall not
			be entitled to a refund as to any other product or service purchased from the Company.
		</p>
		...
		<p>
			THE COMPANY MAKES NO WARRANTIES REGARDING THE PERFORMANCE OR OPERATION OF THIS WEBSITE. THE
			COMPANY FURTHER MAKES NO REPRESENTATIONS OR WARRANTIES OF ANY KIND, EXPRESS OR IMPLIED, AS TO
			THE INFORMATION, CONTENTS, MATERIALS, DOCUMENTS, PROGRAMS, PRODUCTS, BOOKS, OR SERVICES
			INCLUDED ON OR THROUGH THIS WEBSITE. TO THE FULLEST EXTENT PERMISSIBLE UNDER THE LAW, THE
		...
		<p>
			YOU AGREE TO ABSOLVE THE COMPANY OF ANY AND ALL LIABILITY OR LOSS THAT YOU OR ANY PERSON OR
			ENTITY ASSOCIATED WITH YOU MAY SUFFER OR INCUR AS A RESULT OF USE OF THE INFORMATION CONTAINED
			ON THIS WEBSITE AND/OR THE RESOURCES YOU MAY DOWNLOAD FROM THIS WEBSITE. YOU AGREE THAT THE
			COMPANY SHALL NOT BE LIABLE TO YOU FOR ANY TYPE OF DAMAGES, INCLUDING DIRECT, INDIRECT,
		...
		<p>
			...
			INFORMATION HEREIN. THE COMPANY AND/OR ITS SUPPLIERS MAY MAKE IMPROVEMENTS AND/OR CHANGES IN
		...
		<p>
			...
			RELATED GRAPHICS CONTAINED ON THE WEBSITE FOR ANY PURPOSE. TO THE MAXIMUM EXTENT PERMITTED BY
		...
		<p>
			...
			DAMAGES OR ANY DAMAGES WHATSOEVER INCLUDING, WITHOUT LIMITATION, DAMAGES FOR LOSS OF USE, DATA
			OR PROFITS, ARISING OUT OF OR IN ANY WAY CONNECTED WITH THE USE OR PERFORMANCE OF THE WEBSITE,
			WITH THE DELAY OR INABILITY TO USE THE WEBSITE OR RELATED SERVICES, THE PROVISION OF OR
			FAILURE TO PROVIDE SERVICES, OR FOR ANY INFORMATION, SOFTWARE, PRODUCTS, SERVICES AND RELATED
			GRAPHICS OBTAINED THROUGH THE WEBSITE, OR OTHERWISE ARISING OUT OF THE USE OF THE WEBSITE,
			WHETHER BASED ON CONTRACT, TORT, NEGLIGENCE, STRICT LIABILITY OR OTHERWISE, EVEN IF THE
			COMPANY OR ANY OF ITS SUPPLIERS HAS BEEN ADVISED OF THE POSSIBILITY OF DAMAGES. BECAUSE SOME
			...
			ANY PORTION OF THE WEBSITE, OR WITH ANY OF THESE TERMS OF USE, YOUR SOLE AND EXCLUSIVE REMEDY
		...
		<p>
			...
			of or relating to this Website, the Company, any and all contracts you enter into with the
		...
		<p>
			...
			such claim only through binding arbitration to occur in Farmington, NM. You further agree to
			and do hereby waive any right to class arbitration and agree, instead, to conduct an
			arbitration related solely to any individual claims you and/or any entity related to you
			asserts against the Company. To the fullest extent permissible by law, you further agree that
			you shall be responsible for all costs associated with initiating the arbitration and for the
		...
		<p>
			The Service is controlled, operated and administered by the Company from our offices within
		...
		<p>
			...
			to use the Website or services, any user postings made by you, your violation of any terms of
			this Agreement or your violation of any rights of a third party, or your violation of any
			applicable laws, rules or regulations. The Company reserves the right, at its own cost, to
			assume the exclusive defense and control of any matter otherwise subject to indemnification by
			you, in which event you will fully cooperate with the Company in asserting any available
			defenses.
		</p>
		...
		<p>
			...
			maximum extent permitted by law, and you hereby consent to resolve any and all disputes
			arising under or related to this Website or the Terms of Use pursuant to the Arbitration
			Clause above. Use of the Website is unauthorized in any jurisdiction that does not give effect
		...
		<p>
			...
			between you and the Company as a result of this agreement or use of the Website. The Company’s
		...
		<p>
			...
			Disclaimer, constitutes the entire agreement between the user and the Company with respect to
			...
			Website. A printed version of this agreement and of any notice given in electronic form shall
			be admissible in judicial or administrative proceedings based upon or relating to this
			agreement to the same extent and subject to the same conditions as other business documents
			and records originally generated and maintained in printed form. It is the express wish to the
		...
		<p>
			...
			Website is offered. The most current version of the Terms will supersede all previous
			versions. The Company encourages you to periodically review the Terms to stay informed of our
			updates.
		</p>
		...
		<p><em>Effective as of May 3, 2021</em></p>
	</article>
</section>
